import { getFriends, randomDate, dates, randomNumber, getEventSeedData } from "./seedHelpers";
...
export const seedEvents = async ({ users, friendships, groups }: SeedEventsProps) => {
